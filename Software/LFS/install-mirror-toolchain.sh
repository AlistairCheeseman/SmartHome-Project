...
#THIS VERSION USES A LOCAL MIRROR.
set -e
...
git clone git@git.kmxsoftware.co.uk:extern/linux
#cd kernel
cd linux
...
wget https://filestore.kmxsoftware.co.uk/am335x-pm-firmware.bin -O firmware/am335x-pm-firmware.bin
#kernel
