...
/* UNSUBSCRIBE/SUBSCRIBE TOPIC FLAGS */
#define SUBS_TOPICID_NAME	0b00000000
#define SUBS_TOPICID_SETNUM	0b00000001
#define SUBS_TOPICID_ST	0b00000010 //short topic name( FIXED 2 BYTE NAME)
